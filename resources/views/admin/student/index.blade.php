                    ...
                    <table class="min-w-full text-sm text-right border-separate border-spacing-y-2">
                        <thead class="bg-gray-100 text-gray-700">
                            <tr>
                                ...
                                <th class="px-4 py-2 rounded-r-lg">البريد الالكتروني</th>
                                ...
                                <th class="px-4 py-2 text-center"> رقم ولي الامر</th>
                                <th class="px-4 py-2 text-center">المدرسه</th>
                        ...
                        <tbody>
                            @foreach ($students as $student)
                                <tr class="bg-gray-50 text-gray-800"
                                    ...
                                    <td class="px-4 py-2 text-center">{{ $student->nationallity ?? 'لا يوجد جنسية' }}
                                    </td>
                                    <td class="px-4 py-2 text-center">{{ $student->Academic_stage ?? 'لا يوجد مرحله' }}
                                    </td>
                                    <td class="px-4 py-2 text-center">
                                        {{ $student->user->phone ?? 'لم يتم الربط بولي امر' }}</td>
                                    <td>{{ $student->school->name ?? 'لا يوجد مدرسه' }}</td>
