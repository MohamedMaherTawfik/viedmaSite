             ...
             <form action="{{ route('admin.student.update', $student) }}" method="POST"
                 ...
                 <div>
                     ...
                     <input type="text" name="name"
                         ...
                         value="{{ $student->name ?? 'لا يوجد اسم' }}">
                 ...
                 <div>
                     ...
                     <input type="text" name="national_id"
                         class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                         value="{{ $student->national_id ?? 'لا يوجد رقم القومي' }}">
                     @error('national_id')
                         <span class="text-red-500 text-sm">{{ $message }}</span>
                     @enderror
                 </div>
                 ...
                 <div>
                     ...
                     <input type="text" name="email"
                         class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                         value="{{ $student->me->email ?? 'لا يوجد بريد الكتروني' }}">
                     @error('email')
                         <span class="text-red-500 text-sm">{{ $message }}</span>
                     @enderror
                 </div>
                 ...
                 <div>
                     ...
                     <input type="text" name="Academic_stage"
                         class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                         value="{{ $student->Academic_stage ?? 'لا يوجد مرحلة دراسية' }}">
                 ...
                 <div>
                     ...
                     <input type="text" name="nationallity"
                         class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500"
                         value="{{ $student->nationallity ?? 'لا يوجد جنسية' }}">
                     @error('nationallity')
                         <span class="text-red-500 text-sm">{{ $message }}</span>
                     @enderror
                 </div>
                 ...
                 <div>
                     ...
                     <select name="school_id"
                         class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                         <option value="{{ $student->school->id ?? 'لا يوجد مدرسة' }}">
                             {{ $student->school->name ?? 'اختر المدرسة' }}
                         </option>
