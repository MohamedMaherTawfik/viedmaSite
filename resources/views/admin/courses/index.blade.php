                                         ...
                                         <div class="p-6 flex-1 flex flex-col justify-between">
                                             ...
                                             <div class="mt-auto">
                                                 ...
                                                 <div
                                                     ...
                                                     <span class="text-lg ml-4 font-bold text-[#176b98]"> سعر المعلم
                                                         : {{ $course->price ?? 0 }}
                                                     </span>

                                                     <span class="text-lg font-bold text-[#176b98]"> سعر الادمن
                                                     ...
                                                     <div id="editPriceModal-{{ $course->id }}"
                                                         ...
                                                         <div
                                                             ...
                                                             <form
                                                                 action="{{ route('admin.course.edit', $course->id) }}"
                                                                 method="POST">
                                                                 @csrf
                                                                 ...
                                                                 <div class="mb-4">
                                                                     ...
                                                                     <input type="number" step="0.01"
                                                                         name="admin_price" id="admin_price"
