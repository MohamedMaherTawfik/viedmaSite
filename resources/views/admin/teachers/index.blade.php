    ...
    <div class="flex flex-col flex-1">
        <main class="p-6 flex-1">
            ...
            <div class="flex items-center justify-between mb-4">
                <h2 class="text-lg font-semibold">جمبع المعلمين</h2>
                ...
                <div class="overflow-x-auto overflow-visible relative z-[1]">
                    ...
                    <table class="min-w-full text-sm text-right border-separate border-spacing-y-2">
                        <thead class="bg-gray-100 text-gray-700">
                            <tr>
                                <th class="px-4 py-2 rounded-r-lg">اسم المعلم</th>
                                <th class="px-4 py-2 text-center">البريد الإلكتروني</th>
                                <th class="px-4 py-2 text-center">المدرسة</th>
                                <th class="px-4 py-2 text-center">رقم الهاتف</th>
                                <th class="pr-8 pl-4 py-2 text-center rounded-l-lg">إجراء</th>
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            @foreach ($students as $student)
                                <tr class="bg-gray-50 text-gray-800"
                                    data-edit-url="{{ route('admin.teacher.edit', ['teacher' => $student]) }}"
                                    data-delete-url="{{ route('admin.teacher.delete', ['teacher' => $student]) }}">
                                    ...
                                    <td class="px-4 py-2 flex items-center gap-2 text-center">
                                        <img src="https://th.bing.com/th/id/R.4b6a7d8dc6ff6bd305a872c783d2f450?rik=IcLvZ3InG%2bn33g&pid=ImgRaw&r=0"
                                            class="w-8 h-8 rounded-full" alt="صورة المعلم">
                                    ...
                                    <!-- المدرسة -->
                                    <td class="text-center">
                                        {{ $student->school->name ?? 'لا يوجد مدرسة' }}
                                    </td>

                                    <!-- رقم الهاتف -->
                                    <td class="text-center">
                                        {{ $student->phone ?? 'لم يتم الربط بولي أمر' }}
                                    </td>
