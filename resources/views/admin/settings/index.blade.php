...
<main class="p-6 flex-1">
    ...
    <div class="bg-white p-8 rounded-lg shadow-md mt-6">
        <h2 class="text-2xl font-bold mb-6 text-right">{{ __('main.title') }}</h2>
            ...
            <div x-show="tab === 'profile'" x-transition>
                <form class="w-full max-w-3xl mx-auto" action="{{ route('admin.settings.user.update') }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 text-right">
                        <div>
                            <label class="block mb-1 font-medium">{{ __('main.first_name') }}</label>
                        ...
                        <div>
                            <label class="block mb-1 font-medium">{{ __('main.phone') }}</label>
                        ...
                        <div>
                            <label class="block mb-1 font-medium">{{ __('main.email') }}</label>
            ...
            <div x-show="tab === 'password'" x-transition>
                <form class="w-full max-w-2xl mx-auto" method="POST"
                    ...
                    <div class="grid grid-cols-1 gap-6 text-right">
                        <div>
                            <label class="block mb-1 font-medium">{{ __('main.current_password') }}</label>
                        ...
                        <div>
                            <label class="block mb-1 font-medium">{{ __('main.new_password') }}</label>
                        ...
                        <div>
                            <label class="block mb-1 font-medium">{{ __('main.confirm_new_password') }}</label>
