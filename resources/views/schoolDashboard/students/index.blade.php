                        ...
                        <tbody>
                            @foreach ($students as $student)
                                <tr class="bg-gray-50 text-gray-800"
                                    ...
                                    data-link-parent-url="{{ route('school.student.linkParent', ['slug' => request('slug'), 'name' => $student->id]) }}">
                                    ...
                                    <td class="px-4 py-2 text-center">
                                        {{ $student->studentParent->name ?? 'لم يتم الربط بولي امر' }}
                                    </td>
                                    <td class="px-4 py-2 text-center">
                            ...
                            btn.addEventListener('click', function(e) {
                                ...
                                const html = `
                                    ...
                                    <a href='${showUrl}' class='flex items-center gap-2 px-2 py-1 rounded hover:bg-gray-100'>
                                        <span class='w-6 h-6 flex items-center justify-center border border-gray-500 rounded-full'>
