 ...
 <x-layout title="لوحه تحكم المدرسه ">
     ...
     <div class="flex flex-col flex-1">
         ...
         <main class="p-6 flex-1">
             ...
             <form action="{{ route('school.student.store', request('slug')) }}" method="POST"
                 ...
                 <div>
                     ...
                     <input type="text" name="Academic_stage" value="{{ $student->Academic_stage }}"
                         class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                 ...
                 <div>
                     ...
                     <input type="text" name="nationallity" value="{{ $student->nationallity }}"
                         class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
                     @error('nationallity')
                         <span class="text-red-500 text-sm">{{ $message }}</span>
                     @enderror
