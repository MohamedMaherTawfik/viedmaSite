<x-layout title="{{ __('main.school_dashboard') }}">
        ...
        <main class="p-6 flex-1">
            ...
            <section class="bg-white p-4 rounded shadow mt-6">
                <div class="flex items-center justify-between mb-4">
                    <h2 class="text-lg font-semibold">{{ __('main.teachers') }}</h2>
                    ...
                    <table class="min-w-full text-sm text-right border-separate border-spacing-y-2">
                        <thead class="bg-gray-100 text-gray-700">
                            <tr>
                                ...
                                <th class="px-4 py-2">{{ __('main.topic') }}</th>
                                <th class="px-4 py-2">{{ __('main.phone') }}</th>
                                <th class="px-4 py-2">{{ __('main.status') }}</th>
                                <th class="px-4 py-2">{{ __('main.registered_at') }}</th>
