...
<body class="bg-gray-200 min-h-screen">
    <div class="bg-white w-screen h-screen grid grid-cols-1 md:grid-cols-2">
        ...
        <div class="p-10 flex flex-col justify-center">
            ...
            <form method="POST" action="{{ route('school.login.store') }}" class="w-full text-right">
                @csrf
            ...
            <p class="text-center text-sm mt-6">
                ليس لديك حساب؟ <a href="{{ route('school.register') }}" class="text-blue-600 hover:underline">حساب
                    جديد</a>
            </p>
        </div>
    </div>
